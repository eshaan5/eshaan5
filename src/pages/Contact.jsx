...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(import.meta.env.VITE_APP_EMAILJS_SERVICE_ID, import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID, form, import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY)
      .then(() => {
        setIsLoading(false);
        showAlert({ message: "Message sent successfully!", type: "success" });
      ...
      .catch((err) => {
        ...
        setCurrentAnimation("idle");
        console.log(err);
        showAlert({ message: "Failed to send message! Please try again later.", type: "danger" });
        // hide an alert
      });
  };
    ...
    <section className="relative flex lg:flex-row flex-col max-container h-[100vh]">
      ...
      <div className="flex-1 min-w-[50%] flex flex-col">
        ...
        <form className="w-full flex flex-col gap-7 mt-14" onSubmit={handleSubmit}>
          ...
          <label htmlFor="" className="text-black-500 font-semibold">
            Your Message
            <textarea type="text" name="message" className="textarea" rows={4} placeholder="Let me know how can I help you!" required value={form.message} onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur} />
          </label>
